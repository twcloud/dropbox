...
*/
declare const $tw:any, config: any, getLocalPath: Function, displayMessage: any, version: any;

declare interface Window {
	mozillaSaveFile: Function;
	mozillaLoadFile: Function;
	convertUriToUTF8: Function;
	convertUnicodeToFileFormat: Function;
